 ...
 */
export declare function NamespaceSocketIO(): (object: Object, methodName: string, index: number) => void;
/**
 ...
 */
export declare function Middleware(namespace?: string, priority?: number): Function;
/**
 ...
 */
export declare function EmitNamespaceBroadcastOnSuccess(messageName?: string, options?: {
    classTransformOptions?: ClassTransformOptions;
}): Function;
/**
 * If this decorator is set then after controller action will emit message with the given name after action execution
